...
import '../tiles/actor_tile.dart';
import 'detail_actor.dart';

class ListOfActors extends StatefulWidget {
...
class _ListActorsScreenState extends State<ListOfActors> {
                    ...
                    return CustomListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                DetailActor(actor: _actors[index]),
                          ),
                        );
                      },
                    );
